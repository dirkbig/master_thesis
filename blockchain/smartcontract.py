...
def deploy_SC(contract_interface, w3, creator_account):
    ...
    deployment_tx_hash = contract.deploy(transaction={'from': creator_account, 'gas': 4000000})
...
def setter_broadcast(w3, contract_instance):
    """logs the information into the public ledger, a distributed communication system; broadcasting without possibility to lie"""
    contract_instance
    pass

def setter_mint(w3, contract_instance, deployment_tx_hash, contract_address):
    contract_instance.mintToken

    pass

def setter_burn(w3, contract_instance, deployment_tx_hash, contract_address):
    pass
