...
def pso_custom(func, lb, ub, ieqcons=[], f_ieqcons=None, args=(), kwargs={},
    ...
    """ Custom"""
    list_on_iteration = np.zeros((maxiter,S))
            ...
            if fx < fp[i] and is_feasible(x[i, :]):
                ...
                if fx < fg:
                    ...
                    if np.abs(fg - fx) <= minfunc:
                        ...
                        return tmp, fx, list_on_iteration, it
    ...
    return g, fg, list_on_iteration, it